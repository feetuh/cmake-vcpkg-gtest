...
hidden if the `example-vc_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `example-vc_DEVELOPER_MODE` to the configure
...
> **Note**
>  "cacheVariables": {
>    "CMAKE_TOOLCHAIN_FILE": "/home/feetuh/.vcpkg/scripts/buildsystems/vcpkg.cmake"
>  }
> // use $env{VCPKG_ROOT} when feature is fixed.
...
Runs the executable target `example-vc_exe`.
